...
//  AppStoreAnimation
//
//  Created by Tal Spektor on 04/09/2022.
//
    ...
    func DetailView(item: Today) -> some View {
                ...
                VStack(spacing: 15) {
                    ...
                    Button {
                        ...
                        Label {
                            ...
                            Image(systemName: "squate.and.arrow.up.fill")
                        }
                        .foregroundColor(.primary)
                        .padding(.vertical, 5)
        ...
        .overlay(alignment: .topTrailing, content: {
            Button {
                ...
                withAnimation(.interactiveSpring(response: 0.6, dampingFraction: 0.7, blendDuration: 0.7).delay(0.7)) {
                    currentItem = nil
